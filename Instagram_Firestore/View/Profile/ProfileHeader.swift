...
class ProfileHeader: UICollectionReusableView {
    ...
    var viewModel: ProfileHeaderViewModel? {
        //Tambien se ejecuta cuando damos click en boton de "follow"
        didSet { configure() }
    }
    ...
    override init(frame: CGRect) {
        ...
        stack.anchor(left: profileImageView.rightAnchor, right: rightAnchor, paddingLeft: 12, paddingRight: 50)
    ...
    @objc func handleEditProfileFollowTapped() {
        ...
        headerDelegate?.header(self, didTapActionButtonFor: viewModel.user)
    }
