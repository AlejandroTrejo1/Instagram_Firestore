...
class CommentInputAccesoryView: UIView {
    // MARK: - Properties
    weak var inputDelegate: CommentInputAccesoryViewDelegate?
    
    private let commentTextView: InputTextView = {
       let tv = InputTextView()
        tv.placeHolderText = "Comentar"
    ...
    @objc func handlePostTapped() {
        inputDelegate?.inputView(self, wantsToUploadComment: commentTextView.text)
    }
