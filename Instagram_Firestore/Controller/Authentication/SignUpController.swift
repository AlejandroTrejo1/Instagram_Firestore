...
class SignUpController: UIViewController {
    ...
    private lazy var customAppleButton: UIButton = {
        ...
        let image = UIImage(named: "SignUpApple")
    ...
    private lazy var customGoogleButton: UIButton = {
        let button = UIButton(type: .custom)
        let image = UIImage(named: "SignUpGoogle")
        button.setImage(image, for: .normal)
    ...
    private lazy var  emailSignButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(signInEmail), for: .touchUpInside)
        return button
    }()
    ...
    private lazy var customFacebookButton: UIButton = {
        let button = UIButton(type: .custom)
        let image = UIImage(named: "SignUpFacebook")
        button.setImage(image, for: .normal)
    ...
    private let emailSignIn: UIButton = {
        let button = UIButton(type: .custom)
        let image = UIImage(named: "SignUpEmail")
        button.setImage(image, for: .normal)
        button.addTarget(self, action: #selector(switchToEmailSignUp), for: .touchUpInside)
        return button
    }()
...
extension SignUpController: ResetPasswordControllerDelegate {
