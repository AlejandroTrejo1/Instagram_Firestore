...
class UploadPostController: UIViewController {
    ...
    weak var uploadDelegate: UploadPostControllerDelegate?
    ...
    lazy var captionTextView: InputTextView = {
        ...
        tv.placeHolderText = "Inserta descripción."
    ...
    @objc func didTapDone() {
        ...
        PostService.uploadPost(caption: caption, image: image, user: user) { error in
            ...
            self.uploadDelegate?.controllerDidFinishedUploadingPost(self)
    ...
    func configureUI() {
        ...
        navigationItem.title = "Publicar"
        
        navigationItem.leftBarButtonItem = UIBarButtonItem(barButtonSystemItem: .cancel,
                                                           target: self,
                                                           action: #selector(didTapCancel))
        
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Compartir", style: .done,
                                                            target: self,
